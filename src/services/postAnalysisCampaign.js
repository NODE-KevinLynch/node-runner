...
// Emails 2-21: Coaching-oriented nudges toward Lynch Method activation
...
<table cellpadding="0" cellspacing="0" style="font-family:Georgia,serif;font-size:14px;color:#222;line-height:1.6">
  ...
  <tr><td>&nbsp;</td></tr>
  <tr><td><a href="https://analysis.lynchperformancesystems.com" style="color:#1a0dab;font-weight:bold">Get Your Free 60 Second Business Strategy Analysis</a></td></tr>
...
<p><strong>Activate your free Lynch Method coaching portal.</strong> It takes about 5 minutes and gives you a personalized coaching plan built around your specific bottleneck — with daily actions, a scorecard, and a clear roadmap to hit your income goal.</p>

<div style="text-align:center;margin:28px 0">
  <a href="https://analysis.lynchperformancesystems.com" style="display:inline-block;padding:16px 36px;background:#1a2b4a;color:#fff;text-decoration:none;border-radius:8px;font-weight:bold;font-size:16px">Activate My Free Lynch Method Portal</a>
</div>
...
<p>Either way — the data is clear and the opportunity is real. I hope to help you close the gap and live your next chapter higher.</p>`;
  ...
  return {
    2: {
      ...
      innerBody: `
        ...
        <p>That is exactly what we build together in the Lynch Method coaching program.</p>
        <p><a href="https://analysis.lynchperformancesystems.com" style="color:#1a0dab;font-weight:bold">Activate your free coaching portal.</a></p>
      `,
    },
    3: {
      ...
      innerBody: `
        ...
        <p><a href="https://analysis.lynchperformancesystems.com" style="color:#1a0dab;font-weight:bold">Activate your Lynch Method portal now.</a> It is free. It is focused. And it might be the decision that changes your year.</p>
    ...
    4: {
      ...
      innerBody:
        ...
        insight.truth +
        '</p><p>Here is what that means in real numbers: if your goal is to earn more this year, the path is not mysterious. It is math. How many closings do you need? How many listings? How many appointments? How many conversations per day?</p><p>When you know your daily number, everything changes. You stop guessing and start engineering.</p><p>The Lynch Method calculates this for you automatically and tracks your progress in real time.</p><p><a href="https://analysis.lynchperformancesystems.com" style="color:#1a0dab;font-weight:bold">See your numbers here.</a></p>',
    },
    5: {
      ...
      innerBody:
        ...
        insight.gap +
        ' as your primary constraint. That means the work you do on this one area over the next 90 days will determine your results three months from now.</p><p>The Lynch Method gives you a daily action plan built around this exact constraint so you are never wondering what to do next.</p><p><a href="https://analysis.lynchperformancesystems.com" style="color:#1a0dab;font-weight:bold">Start your 90-day plan.</a></p>',
    },
    6: {
      ...
      innerBody:
        ...
        insight.gap +
        '. The Lynch Method includes a daily scorecard designed to keep you accountable to the specific activities that move the needle.</p><p><a href="https://analysis.lynchperformancesystems.com" style="color:#1a0dab;font-weight:bold">Get your scorecard.</a></p>',
    },
    7: {
      ...
      innerBody:
        ...
        insight.truth +
        '</p><p>But here is the part most people miss: that gap is not a character flaw. It is a skills gap. And skills gaps close fast when you have the right system and accountability.</p><p>The agents I work with who commit to 90 days of focused action see a measurable shift. Not because they are special. Because they stopped doing everything and started doing the right thing.</p><p>The Lynch Method is free for 30 days. You have nothing to lose except the patterns holding you back.</p><p><a href="https://analysis.lynchperformancesystems.com" style="color:#1a0dab;font-weight:bold">Activate your Lynch Method.</a></p>',
    },
    8: {
      ...
      innerBody:
        ...
        insight.gap +
        ' is your bottleneck. The Lynch Method builds a daily ritual around fixing this with specific actions, a scorecard, and weekly tracking.</p><p><a href="https://analysis.lynchperformancesystems.com" style="color:#1a0dab;font-weight:bold">Build your morning routine.</a></p>',
    },
    9: {
      ...
      innerBody:
        ...
        insight.gap +
        ' as your growth constraint. Consistency in this one area is worth more than excellence in ten others.</p><p>The Lynch Method is designed to build that consistency one day at a time.</p><p><a href="https://analysis.lynchperformancesystems.com" style="color:#1a0dab;font-weight:bold">Start building consistency.</a></p>',
    },
    10: {
      ...
      innerBody:
        ...
        insight.gap +
        '. The Lynch Method helps you stack these small wins daily until the compound effect kicks in.</p><p><a href="https://analysis.lynchperformancesystems.com" style="color:#1a0dab;font-weight:bold">Start compounding.</a></p>',
    },
    11: {
    ...
    12: {
      ...
      innerBody:
        ...
        insight.gap +
        '.</p><p>You have made more calls. Followed up more consistently. Tracked your numbers for the first time. And you can already feel the momentum building.</p><p>Which version do you want?</p><p>The Lynch Method is free for 30 days. The only cost is the decision to start.</p><p><a href="https://analysis.lynchperformancesystems.com" style="color:#1a0dab;font-weight:bold">Start your 30 days now.</a></p>',
    },
    13: {
      ...
      innerBody:
        ...
        insight.gap +
        ' is the area with the most opportunity in your business. That has not changed and neither has the offer.</p><p>The Lynch Method is still available to you. Free for 30 days. Personalized to your bottleneck. Built to create real change.</p><p>If the timing was not right before, maybe it is now.</p><p><a href="https://analysis.lynchperformancesystems.com" style="color:#1a0dab;font-weight:bold">Activate your Lynch Method.</a></p>',
    },
    14: {
    ...
    15: {
      ...
      innerBody:
        ...
        insight.gap +
        ' as their primary constraint.</p><p>The ones who activated the Lynch Method and followed the system for 90 days saw measurable improvement. More consistent prospecting. Better follow-up. Higher conversion. Real numbers, not just feelings.</p><p>They did not have more time than you. They did not have a better market. They just decided to build a system around their weakness instead of ignoring it.</p><p>The Lynch Method is still free for 30 days.</p><p><a href="https://analysis.lynchperformancesystems.com" style="color:#1a0dab;font-weight:bold">Join them.</a></p>',
    },
    16: {
      ...
      innerBody:
        ...
        insight.gap +
        ' is your biggest opportunity. The Lynch Method gives you the system. Daily actions, weekly tracking, and a clear roadmap.</p><p>Treat your business like you treat your clients. Give it the structure it deserves.</p><p><a href="https://analysis.lynchperformancesystems.com" style="color:#1a0dab;font-weight:bold">Build your system.</a></p>',
    },
    17: {
      subject:
      ...
      innerBody:
        ...
        insight.gap +
        '. Not because the rest does not matter but because fixing this one constraint unlocks everything else.</p><p>The Lynch Method is built around this principle. One bottleneck. One daily action. One scorecard. Relentless focus until it is fixed.</p><p><a href="https://analysis.lynchperformancesystems.com" style="color:#1a0dab;font-weight:bold">Focus on your one thing.</a></p>',
    },
    18: {
      ...
      innerBody:
        ...
        insight.gap +
        '. The Lynch Method is still free for 30 days. And I am still here to help.</p><p>Sometimes the right time is simply when you decide it is.</p><p><a href="https://analysis.lynchperformancesystems.com" style="color:#1a0dab;font-weight:bold">Decide today.</a></p>',
    },
    19: {
      subject:
        firstName +
      ...
      innerBody:
        ...
        insight.gap +
        ' as your primary constraint. Ninety days of focused work on this one area can change your trajectory. Not just for this quarter, but for the year. Live your next chapter higher.</p><p>The Lynch Method gives you the roadmap. Free for 30 days. No risk.</p><p><a href="https://analysis.lynchperformancesystems.com" style="color:#1a0dab;font-weight:bold">Start your 90 days.</a></p>',
    },
    20: {
      ...
      innerBody:
        ...
        insight.truth +
        ' That is a fixable problem. I fix it with agents every week.</p><p>If you ever want to take the next step, the Lynch Method will be there. Free for 30 days. Personalized to your specific situation.</p><p>I wish you the best either way. And if you ever want to talk, my calendar is always open.</p><p><a href="https://analysis.lynchperformancesystems.com" style="color:#1a0dab;font-weight:bold">Your Lynch Method is ready when you are.</a></p>',
    },
    21: {
      ...
      innerBody:
        ...
        insight.gap +
        ' as your biggest growth opportunity. If you ever decide to work on it with a structured system, the Lynch Method is there for you. Free for 30 days, personalized to your business.</p><p>No matter what, I hope you have a phenomenal year — and live your next chapter higher.</p><p><a href="https://analysis.lynchperformancesystems.com" style="color:#1a0dab;font-weight:bold">Activate anytime.</a></p><p>All the best,</p>',
    },
  };
}
...
function getPostAnalysisEmail(agentId, firstName, step) {
  ...
  const assessmentUrl =
    "https://analysis.lynchperformancesystems.com?" + params.toString();
  ...
  if (step === 1) {
    ...
    const innerBody = email1.innerBody.replace(
      /https:\/\/analysis\.lynchperformancesystems\.com/g,
      assessmentUrl,
    );
    return {
      subject: email1.subject,
      html: wrapHtml(innerBody, agentId),
  ...
  const innerBody = email.innerBody.replace(
    /https:\/\/analysis\.lynchperformancesystems\.com/g,
    assessmentUrl,
  );
