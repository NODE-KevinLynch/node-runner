...
// 12-email sequence for agents with no analysis completed yet
...
// Email bodies (without the wrapping HTML). Wrapped per-agent below
// so the unsubscribe link can be agent-specific.
const EMAIL_BODIES = {
  1: {
    ...
    body: `
      ...
      <p><a href="https://analysis.lynchperformancesystems.com" style="color:#1a0dab;font-weight:bold">Run your free analysis here.</a></p>
  ...
  2: {
    ...
    body: `
      ...
      <p><a href="https://analysis.lynchperformancesystems.com" style="color:#1a0dab;font-weight:bold">Find your bottleneck here.</a></p>
  ...
  3: {
    ...
    body: `
      ...
      <p><a href="https://analysis.lynchperformancesystems.com" style="color:#1a0dab;font-weight:bold">Run your free Agent Analysis now.</a></p>
