...
// Email bodies are now built per-call with agentId, so the footer
// can include the agent-specific unsubscribe link. Each entry is
// { subject, bodyFn(firstName) -> innerHtml }. wrapHtml is applied
// at the public function below with the agentId.
const EMAILS = {
