...
// Theme: The Lynch Method is the hero, Sutton Group is the provider, coaching insights are seasoning
// Each email delivers: a piece of real estate wisdom + a Lynch Method exclusive reminder + CTA
...
<table cellpadding="0" cellspacing="0" style="font-family:Georgia,serif;font-size:14px;color:#222;line-height:1.6">
  ...
  <tr><td>&nbsp;</td></tr>
  <tr><td><a href="https://analysis.lynchperformancesystems.com" style="color:#1a0dab;font-weight:bold">Start Your Free Lynch Method Journey — Sutton Agents Only</a></td></tr>
</table>
`;
...
const EMAILS = {
  ...
  1: {
    subject: "Sutton Group has done it again — The Lynch Method is live",
    bodyFn: (firstName) => `
      ${greeting(firstName)}
      ...
      <p><strong>The Lynch Method is now live.</strong> It is the most advanced coaching and accountability system ever built for real estate agents, and it is free for every Sutton agent in Canada.</p>
      <p>What is inside:</p>
      <ul>
      ...
      <p><strong>Real estate insight of the week:</strong> The single biggest predictor of next year's income is not your market or your marketing — it is the number of meaningful conversations you are having every single day. The Lynch Method tracks this. Most agents do not.</p>
      ${ctaBlock("Activate My Free Lynch Method")}
      <p>Welcome to the next chapter — and live it higher.</p>
    `,
  },

  // ── EMAIL 2 — THE 30-DAY RULE ──────────────────────────────────
  2: {
    ...
    bodyFn: () => `
      ...
      <p><strong>This is exactly what The Lynch Method enforces.</strong> Your dashboard tells you, every day, whether you are doing the work that will pay you in 90 days — or whether you are coasting on momentum that is about to run out.</p>
      <p>And because you are a Sutton agent, it is yours at no cost.</p>
      ${ctaBlock("Start My Lynch Method Diagnosis")}
    `,
  },
  ...
  3: {
    ...
    bodyFn: () => `
      ...
      <p><strong>The Lynch Method tells you, every morning, what your highest-value activity should be that day — based on your numbers, your goals, and your specific bottleneck.</strong></p>
  ...
  4: {
    ...
    bodyFn: () => `
      ...
      <p><strong>The Lynch Method's follow-up tracking surfaces every lead that has gone cold, every conversation that needs a touch, every relationship at risk of going dark.</strong> It is the difference between hoping you are following up and knowing you are.</p>
  ...
  5: {
    ...
    bodyFn: () => `
      ...
      <p><strong>The Lynch Method's Relationship Capital module shows you exactly who in your database is overdue for a touch, who is most likely to refer, and what to say when you reach out.</strong></p>
  ...
  6: {
    ...
    bodyFn: () => `
      ...
      <p><strong>The Lynch Method's diagnosis tells you exactly where you stand on the hunter-farmer spectrum and what to build next.</strong> Free, for Sutton agents only.</p>
  ...
  7: {
    subject: "Sutton Group: your first month with The Lynch Method — let us talk",
    bodyFn: (firstName) => `
      ${greeting(firstName)}
      <p>You have had access to The Lynch Method for a few weeks now. I want to be straight with you.</p>
      ...
      <p>I built The Lynch Method for agents like you. Sutton funded it. The only thing left is you saying yes — and choosing to live your next chapter higher.</p>
  ...
  8: {
    ...
    bodyFn: () => `
      ...
      <p><strong>The Lynch Method's listing presentation framework gives you the exact sequence top producers use.</strong> Built into your dashboard. Available the moment you activate.</p>
      <p>Sutton Group covers it. You just have to use it.</p>
      ${ctaBlock("Upgrade My Listing Game")}
    `,
  },

  // ── EMAIL 9 — RPM PLAN INTRO ───────────────────────────────────
  9: {
    ...
    bodyFn: () => `
      ...
      <p><strong>The Lynch Method builds this plan for you, updates it as your business shifts, and reminds you of it every single morning.</strong></p>
  ...
  10: {
    ...
    bodyFn: () => `
      ...
      <p><strong>The Lynch Method's relationship capital framework gives you a weekly playbook for who to touch, what to send, and how to deepen the conversations that turn into referrals.</strong></p>
  ...
  11: {
    ...
    bodyFn: () => `
      ...
      <p><strong>The Lynch Method identifies the activities that move the needle in YOUR business — and ruthlessly cuts out the ones that do not.</strong></p>
  ...
  12: {
    ...
    bodyFn: () => `
      ...
      <p><strong>The Lynch Method's diagnosis finds it for you in sixty seconds.</strong> No fluff. No upsell. Just the truth about your business.</p>
      <p>Sutton Group bought you this clarity. Use it.</p>
      ${ctaBlock("Find My One Thing")}
    `,
  },

  // ── EMAIL 13 — TONY ROBBINS NAMED ──────────────────────────────
  13: {
    ...
    bodyFn: () => `
      ...
      <p><strong>The Lynch Method tracks this gap and closes it.</strong> Your daily directive aligns your hours with your stated targets. Sutton agents get it free.</p>
  ...
  14: {
    ...
    bodyFn: (firstName) => `
      ${greeting(firstName)}
      <p>If you are reading this email and you have not yet activated The Lynch Method, I want to gently challenge you.</p>
      ...
      <p>Sutton Group built The Lynch Method for the agents who are ready to live their next chapter higher. Are you one of them?</p>
      ${ctaBlock("Face My Numbers")}
    `,
  },

  // ── EMAIL 15 — JEB BLOUNT NAMED ────────────────────────────────
  15: {
    ...
    bodyFn: () => `
      ...
      <p><strong>The Lynch Method enforces this discipline through your daily directive.</strong> When your pipeline is full, it tells you to keep prospecting. When it is thin, it shows you exactly where to focus first.</p>
  ...
  16: {
    ...
    bodyFn: () => `
      ...
      <p><strong>The Lynch Method tracks your daily activity and shows you the compounding math on your dashboard.</strong> You will see exactly what each day's work is building toward.</p>
  ...
  17: {
    ...
    bodyFn: () => `
      ...
      <p><strong>Sutton Group eliminated that friction entirely.</strong> The Lynch Method delivers structured coaching, accountability, and performance tracking — included with your career, at no additional cost.</p>
  ...
  18: {
    ...
    bodyFn: () => `
      ...
      <p><strong>The Lynch Method measures the leading indicators automatically and flags you the moment your activity drops below the level that produces consistent income.</strong></p>
      <p>This is the discipline Sutton Group is handing you. Free.</p>
      ${ctaBlock("End The Roller Coaster")}
    `,
  },

  // ── EMAIL 19 — MICHAEL MAHER NAMED ─────────────────────────────
  19: {
    ...
    bodyFn: () => `
      ...
      <p><strong>The Lynch Method's relationship capital framework tells you which contacts deserve which level of touch — and when.</strong> It removes the guesswork.</p>
  ...
  20: {
    ...
    bodyFn: () => `
      ...
      <p><strong>The Lynch Method is built on this premise.</strong> It treats your real estate practice as a business with measurable inputs, predictable outputs, and identifiable leverage points.</p>
  ...
  21: {
    ...
    bodyFn: (firstName) => `
      ...
      <p>The Lynch Method is real. It is funded. It is exclusively free for Sutton agents. I built it because I have spent years coaching agents one-on-one and watched the same patterns play out over and over.</p>
      ...
      <p>That is what The Lynch Method does. And it does it for free, because Sutton Group decided to do something no other brokerage has done.</p>
      ...
      <p>I am rooting for you to live your next chapter higher — whichever way you go.</p>
      ${ctaBlock("Activate My Lynch Method")}
    `,
  },
  ...
  22: {
    ...
    bodyFn: () => `
      ...
      <p><strong>The Lynch Method maps your activity against revenue-generating value and shows you exactly which tasks should not be on your plate anymore.</strong> It is the first step toward building a business that scales.</p>
  ...
  23: {
    ...
    bodyFn: () => `
      ...
      <p><strong>The Lynch Method diagnoses your specific business model and prescribes a strategy built around your strengths — not a generic template.</strong></p>
  ...
  24: {
    ...
    bodyFn: () => `
      ...
      <p><strong>The Lynch Method facilitates this weekly review automatically.</strong> Your dashboard surfaces the numbers, asks the questions, and helps you build next week's plan.</p>
      <p>Sutton built it for you. Use it once and you will never go back.</p>
      ${ctaBlock("Start My Weekly Review")}
    `,
  },

  // ── EMAIL 25 — THE ATOMIC HABITS PRINCIPLE ─────────────────────
  25: {
    ...
    bodyFn: () => `
      ...
      <p>This is the principle The Lynch Method is built on. Small, measurable, daily improvements — not heroic overhauls.</p>
  ...
  26: {
    subject: "Sutton Group: six months of The Lynch Method — where are you?",
    bodyFn: () => `
      ...
      <p>Six months ago, Sutton Group gave you free access to a coaching system built specifically to grow your real estate business. If you activated it, you have six months of personalized data, coaching directives, and accountability behind you.</p>
      ...
      <p><strong>Sixty seconds. One diagnosis. A clear path forward — and a chance to live your next chapter higher.</strong></p>
      ${ctaBlock("Activate The Lynch Method Now")}
...
/**
 * Get a Sutton pre-activation email for the given step.
 * @param {number} step - 1-indexed campaign step
 * @param {string} [firstName] - agent's first name for personalized greetings
 * @param {string} [agentId] - if provided, appends an agent-specific unsubscribe footer
 */
function getSuttonPreActivationEmail(step, firstName, agentId) {
  ...
  const innerHtml = email.bodyFn(firstName);

  return {
    subject: email.subject,
    html: wrapHtml(innerHtml, agentId),
