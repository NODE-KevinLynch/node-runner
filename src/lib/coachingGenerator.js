...
const EVENT_PLAYBOOK_MOVES = {
  listing: [
    ...
    { title: "4. Open House Plan (Seller Service + Buyer Pipeline)", type: "steps",
      body: "Treat the open house as a lead-gen engine, not just a showing — it works the seller's home AND fills your buyer pipeline:\n\u2022 THIS WEEKEND: lock the date, order directional + A-frame signage, block 2 hours.\n\u2022 PROMOTE WIDE: social (feed + stories + a short walk-through video), database email, and a personal invite to the immediate neighbours — they know buyers who want in.\n\u2022 NEIGHBOUR ANGLE: door-knock the surrounding streets with a private-preview invite the day before. Every neighbour is a future seller and a buyer source.\n\u2022 CAPTURE EVERYONE: require a sign-in (name, phone, working-with-an-agent, timeline). No exceptions — that sheet IS the ROI.\n\u2022 CONVERT FAST: text every unrepresented visitor within 24 hours, add them to a follow-up sequence, book second showings.\n\u2022 SERVE THE SELLER: send a same-day recap — traffic count, feedback, next steps. Visible momentum is how you earn price-reduction trust later." },
